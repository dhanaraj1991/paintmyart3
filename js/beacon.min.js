    ...
    !(function () {
      function e() {
        ...
        return (
          ...
          b &&
            ((r.lcp = b.lcp && void 0 !== b.lcp.value ? b.lcp : r.lcp),
            (r.fid = b.fid && void 0 !== b.fid.value ? b.fid : r.fid),
            (r.cls = b.cls && void 0 !== b.cls.value ? b.cls : r.cls)),
          R && g && (r.siteToken = g.token),
          r
        );
      }
      function t(e, t) {
        ...
        var u = n.timing,
          ...
          h = {
            ...
            versions: { fl: g ? g.version : "", js: "2021.5.3", timings: 1 },
            pageloadId: m,
            location: l,
          };
        if (void 0 == w) {
        ...
        if (
          ((h.documentWriteIntervention = a()),
          (h.firstPaint = o("first-paint")),
          (h.firstContentfulPaint = o("first-contentful-paint")),
          (h.errorCount = window.__cfErrCount || 0),
          b &&
            ((h.largestContentfulPaint =
              b.lcp && void 0 !== b.lcp.value ? b.lcp.value : -1),
            (h.firstInputDelay =
              b.fid && void 0 !== b.fid.value ? b.fid.value : -1),
            (h.cumulativeLayoutShift =
              b.cls && void 0 !== b.cls.value ? b.cls.value : -1)),
          R && g && ((h.siteToken = g.token), (T = !0)),
          "function" == typeof n.getEntriesByType)
        ) {
          ...
          E.forEach(function (e) {
            ...
            window.__cfBeaconCustomTag &&
              ...
              h.tempResources &&
                void 0 === h.tempResources[L] &&
                (h.tempResources[L] = []);
            var n = JSON.stringify(t).length;
            _ + n < 62e3 && h.tempResources
              ? ((_ += n), h.tempResources[L].push(t))
              : (L++, (_ = 0));
          });
        }
        return (
          JSON.stringify(h).length >= 64e3 && (h.resources = []),
          R &&
            1 === h.eventType &&
            (void 0 !== w &&
              (delete h.timings,
              delete h.memory,
              delete h.errorCount,
              delete h.documentWriteIntervention),
            delete h.firstPaint,
            delete h.firstContentfulPaint,
            delete h.largestContentfulPaint,
            delete h.firstInputDelay,
            delete h.cumulativeLayoutShift),
          h
        );
      }
      var n =
      ...
      if (!g || "single" !== g.load) {
        ...
        var b = { lcp: void 0, cls: void 0, fid: void 0 },
          E = function (e) {
            ...
            "CLS" === e.name
              ? (b.cls = { value: e.value, path: t })
              : "FID" === e.name
              ? (b.fid = { value: e.value, path: t })
              : "LCP" === e.name && (b.lcp = { value: e.value, path: t });
          };
        if (
          ...
          var I = R
            ...
            k = function (e) {
              var n = function (e, t, n) {
                  (i.resources = e),
                    0 != t && (i.bypassTiming = !0),
                    g &&
                      (1 === g.r && (i.resources = []),
                      R &&
                        B &&
                        0 === t &&
                        (y.push({ id: i.pageloadId, url: i.location }),
                        y.length > 3 && y.shift()),
                      d.sendObjectBeacon(n, i, function () {}, !1, I),
                      void 0 !== g.forward &&
              ...
              if (i && g) {
                var r = "req_id=" + g.rayId,
                  o = i.tempResources;
                if (
                  (delete i.tempResources,
                  R && B && o && 0 === o.length && n([], 0, r),
                  !o)
                )
                  return;
            ...
            A = function (n) {
              ...
              n || ((i.resources = []), delete i.tempResources),
                g &&
                  d.sendObjectBeacon(
                    "req_id=" + g.rayId,
                    i,
  ...
  function (e, t, n) {
    ...
    var i,
      ...
      p = function (e, t, n) {
        ...
        return function () {
          t.value >= 0 &&
            (n || l.has(t) || "hidden" === document.visibilityState) &&
            ((t.delta = t.value - (i || 0)),
          ...
          o = s("paint", function (e) {
            "first-contentful-paint" === e.name &&
              ...
              e.startTime < i.timeStamp &&
                ((r.value = e.startTime), r.entries.push(e), l.add(r), n()));
          });
        o &&
          ((n = p(e, r, t)),
          d(function (i) {
